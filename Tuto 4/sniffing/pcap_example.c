 ...
 *      Author: jiaziyi
 * 	
 * 	Modified by: João Andreotti
 * 	Tutorial: 4 sniffing DNS
 *  Observations:
 * 		Most of the code is adapted from the previous tutorial and from the problem statement.
 */
...
int main(int argc, char *argv[])
{
	...
	*(dev_name + strlen(dev_name) - 1) = '\0'; //the pcap_open_live don't take the last \n in the end
	...
	printf("Filter applied to device! Begin sniffing...\n");
